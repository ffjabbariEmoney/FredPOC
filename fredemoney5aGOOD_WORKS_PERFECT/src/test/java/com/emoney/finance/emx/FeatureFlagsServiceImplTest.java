...
public class FeatureFlagsServiceImplTest {
	...
	public void test() {
		...
		ObjectFactory<FeatureFlagsServiceImpl> configFactory = new ObjectFactory();
		Map<String, Object> mapParam = new HashMap<String, Object>();
		mapParam.put(FeatureFlagsServiceImpl.class.getName() + ".field1", "field1V");
		mapParam.put(FeatureFlagsServiceImpl.class.getName() + ".field2", "field2V");
		mapParam.put(FeatureFlagsServiceImpl.class.getName() + ".field3", "field3V");
		...
		FeatureFlagsServiceImpl clientContext = configFactory.create(FeatureFlagsServiceImpl.class.getName(), mapParam);
