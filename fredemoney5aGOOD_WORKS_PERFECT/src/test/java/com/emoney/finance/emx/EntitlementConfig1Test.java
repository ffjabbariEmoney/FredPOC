...
public class EntitlementConfig1Test {

	@Test
	public void test() {
		

		ObjectFactory<EntitlementConfig1> configFactory = new ObjectFactory();
		...
		EntitlementConfig1 clientContext = configFactory.create(EntitlementConfig1.class.getName(), mapParam);
