...
public class EntitlementConfigTest {

	@Test
	public void test() {
		

		ObjectFactory<EntitlementConfig> configFactory = new ObjectFactory();
		...
		EntitlementConfig clientContext = configFactory.create(EntitlementConfig.class.getName(), mapParam);
